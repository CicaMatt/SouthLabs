...
const FIELD_CONTROL_CLASS = [
  ...
  'focus:shadow-[inset_0_0_0_1px_rgba(26,45,78,0.72)]'
].join(' ');
...
const FORM_PANEL_CLASS = 'solution-card-surface rounded-xl border-t-4 border-[#1a2d4e] p-8 shadow-[0_4px_20px_rgba(19,27,46,0.04)]';
...
const SUBMIT_BUTTON_CLASS = [
  ...
  'shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] hover:shadow-[0_8px_40px_rgba(26,45,78,0.25)]',
